...
-- enemies on/off. Selection state lives on the Game (ctx.menu).
...
return function(ctx)
  ...
  love.graphics.rectangle("fill", 30, 34, 200, 108)
  love.graphics.setColor(pcol(6))
  love.graphics.setLineWidth(1)
  love.graphics.rectangle("line", 30.5, 34.5, 199, 107)
  ...
  love.graphics.print("up/down: select  c: toggle  z/x: close", 44, 94)
  love.graphics.print("m / start: panel", 44, 104)
